...
def new_record():
    ...
    try:
        ...
        curslibrary.execute(
            'CREATE TABLE Bookdetails(Book_id INTEGER PRIMARY KEY, Title TEXT(25) NOT NULL, Author TEXT(30) NOT NULL, '
            'Price REAL NOT NULL);')

        # add the first add to the database
        curslibrary.execute('INSERT INTO Bookdetails(Book_id, Title, Author, Price) VALUES (?, ?, ?, ?);',
